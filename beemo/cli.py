...
@app.command("logs")
def do_logs(
    input: Annotated[Optional[Path], typer.Argument(help="gz file or directory of gz files")] = None,
    csv_dir: Annotated[Optional[Path], typer.Option(help="Output directory for CSV files")] = None,
    pattern: Annotated[Optional[str], typer.Option(help="Filename glob pattern when input is a directory")] = None,
):
...
def do_report(
    ...
    templates_dir: Annotated[Optional[Path], typer.Option(help="Chameleon templates directory")] = None,
    ...
    base_url: Annotated[Optional[str], typer.Option(help="Site base URL e.g. https://bennuttall.com")] = None,
